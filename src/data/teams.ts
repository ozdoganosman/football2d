...
export const KIZILKAYA: TeamInfo = {
  ...
  starters: [
    ...
    p('Koçero', 4, 'DF', { base: 12, tackling: 16, positioning: 15, pace: 10, shooting: 5 }),
    p('Baltacı', 5, 'DF', { base: 11, tackling: 15, positioning: 14, shooting: 5 }),
    ...
    p('Aksungur', 11, 'MF', { base: 13, pace: 16, dribbling: 15, passing: 12 }),
    p('Bozdoğan', 9, 'FW', { base: 13, shooting: 16, pace: 14, dribbling: 13, tackling: 6 }),
    p('Çelenk', 10, 'FW', { base: 13, shooting: 15, passing: 14, dribbling: 14, tackling: 6 }),
  ],
  subs: [
...
export const MAVIDERE: TeamInfo = {
  ...
  starters: [
    ...
    p('Ertaş', 4, 'DF', { base: 11, tackling: 15, positioning: 14, pace: 9, shooting: 5 }),
    p('Kayra', 5, 'DF', { base: 11, tackling: 14, positioning: 13, shooting: 5 }),
    ...
    p('Rüzgar', 7, 'FW', { base: 12, pace: 16, dribbling: 15, shooting: 12, tackling: 5 }),
    p('Umutlu', 9, 'FW', { base: 12, shooting: 15, pace: 13, positioning: 13, tackling: 5 }),
    p('Serinsu', 11, 'FW', { base: 12, pace: 15, dribbling: 14, shooting: 12, tackling: 5 }),
  ],
  subs: [
